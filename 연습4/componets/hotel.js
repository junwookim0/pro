                ...
                <v-row class="mt-9 mb-9">
                    ...
                    <v-hover v-slot="{ hover }">
                        ...
                        >
                            ...
                            <v-img :src="item.src" style="cursor:pointer"
                            >
                            </v-img>
                            </a>
                        </v-card>
            ...
            ISO : [
                {
                    ...
                    link : "./img/아파트/아이소/21평 아파트 ISO-01.PNG",
                },
                {
                    name :"2" ,
                    src : "./img/아파트/아이소/21평 아파트 ISO-02.PNG",
                    link : "./img/아파트/아이소/21평 아파트 ISO-02.PNG",
                },
                {
                    name :"3" ,
                    src : "./img/아파트/아이소/21평 아파트 ISO-03.PNG",
                    link : "./img/아파트/아이소/21평 아파트 ISO-03.PNG",
                },
                {
                    name :"4" ,
                    src : "./img/아파트/아이소/21평 아파트 ISO-04.PNG",
                    link : "./img/아파트/아이소/21평 아파트 ISO-04.PNG",
                },
            ],
        }
    },
